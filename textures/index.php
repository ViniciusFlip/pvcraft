...
if (!isset($_SESSION['return_url']) && !isset($_GET['login_success'])) {
...
<head>
    ...
    <title id="pageTitle">PVCRAFT - Texture Details</title>
    <meta name="description" content="View detailed information about this Minecraft Bedrock texture on PVCRAFT. Download MCPE textures and resources created by the community." id="pageDescription">
    <meta name="keywords" content="Minecraft PE texture, MCPE texture, Bedrock texture, PVCRAFT texture, download MCPE texture, Minecraft resource pack">

    <!-- Canonical -->
    <link rel="canonical" href="https://pvcraft.net/textures/index.html" id="canonicalLink">
    ...
    <meta property="og:url" content="https://pvcraft.net/textures/index.html" id="ogUrl">
    <meta property="og:title" content="PVCRAFT - Texture Details" id="ogTitle">
    <meta property="og:description" content="View detailed information about this Minecraft Bedrock texture. Download community-made MCPE textures and resource packs." id="ogDescription">
    <meta property="og:image" content="https://www.pvcraft.net/home/imgs/home.jpg" id="ogImage">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://pvcraft.net/textures/index.html" id="twitterUrl">
    <meta property="twitter:title" content="PVCRAFT - Texture Details" id="twitterTitle">
    <meta property="twitter:description" content="View detailed information about this Minecraft Bedrock texture. Download community-made MCPE textures and resource packs." id="twitterDescription">
    ...
    <script type="module">
        ...
        async function loadTexture() {
            if (!textureId) {
                window.location.href = "/textures/index.html";
                return;
            }
            ...
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    const aboutContent = data.about || "A Minecraft Pocket Edition texture pack.";
                        ...
                        <div class="carousel-slides">
                            ${images.map((img, index) => `
                                <div class="carousel-slide ${index === 0 ? 'active' : ''}">
                                    <img src="${img}" alt="Imagem ${index + 1} da textura" class="carousel-image">
                                </div>
                            `).join('')}
                        </div>
                ...
                `;
                    ...
                    <div class="additional-info">
                        <div class="info-section">
                            <h3 class="info-title">About the texture</h3>
                ...
                `;
                    ...
                    // Load related textures - NOVA IMPLEMENTAÇÃO
                    loadRelatedTextures(data, textureId);
                } else {
                    window.location.href = "/textures/index.html";
                }
            } catch (error) {
        ...
        function extractKeywords(content) {
            ...
            const commonWords = ['the', 'and', 'for', 'with', 'this', 'that', 'are', 'from', 'you', 'your', 'minecraft', 'texture', 'textures', 'pe', 'mcpe', 'bedrock', 'pack', 'resource', 'hd', 'realistic', 'faithful'];
        ...
        async function loadRelatedTextures(currentContent, currentId) {
            try {
                // Buscar todas as textures (excluindo a atual)
                const allTexturesQuery = query(
                ...
                const querySnapshot = await getDocs(allTexturesQuery);
                ...
                console.log('Textures relacionadas ordenadas:', scoredContent.slice(0, 5));
                ...
                if (selectedContent.length > 0) {
                    selectedContent.forEach(item => {
                        ...
                        html += `
                        <div class="side-card">
                            <a href="/textures/index.php?id=${item.id}">
                    ...
                    console.log('Nenhuma textura relacionada encontrada, usando fallback aleatório');
                ...
                html += `
                <div class="view-more">
                    <a href="/textures/index.html">
                        <i class="fas fa-ellipsis-h"></i> SEE MORE TEXTURES
                    </a>
                </div>
                `;
                ...
                console.error("Error loading related textures:", error);
                
                // Fallback: mostrar mensagem de erro
                document.querySelector('.side-cards').innerHTML = `
                    <div class="error-message">
                        <p>Unable to load related textures at this time.</p>
                        <div class="view-more">
                            <a href="/textures/index.html">
                                <i class="fas fa-ellipsis-h"></i> BROWSE ALL TEXTURES
                            </a>
                        </div>
                    </div>
                `;
        ...
        document.addEventListener('DOMContentLoaded', loadTexture);
    </script>
        ...
        <div class="navbar-container">
            ...
            <div class="search-container">
                <form id="searchForm" action="/home/index.html" method="get">
                    <input type="text" id="pesquisa" name="q" placeholder="Search textures...">
            ...
            <div class="content">
                <div class="page">
                    ...
                    <div class="loading" style="text-align: center; padding: 50px;">
                        <i class="fas fa-spinner fa-spin"></i> Loading texture details...
                    </div>
                </div>
                <div class="side-cards">
                    <!-- Related content will be loaded here dynamically -->
                    <div class="loading" style="text-align: center; padding: 20px;">
                        <i class="fas fa-spinner fa-spin"></i> Loading related textures...
                    </div>
                </div>
            </div>
