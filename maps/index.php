...
<head>
    ...
    <title id="pageTitle">PVCRAFT - Map Details</title>
    <meta name="description" content="View detailed information about this Minecraft Bedrock map on PVCRAFT. Download MCPE maps created by the community." id="pageDescription">
    <meta name="keywords" content="Minecraft PE map, MCPE map, Bedrock map, PVCRAFT map, download MCPE map, Minecraft world">

    <!-- Canonical -->
    <link rel="canonical" href="https://pvcraft.net/maps/index.html" id="canonicalLink">
    ...
    <meta property="og:url" content="https://pvcraft.net/maps/index.html" id="ogUrl">
    <meta property="og:title" content="PVCRAFT - Map Details" id="ogTitle">
    <meta property="og:description" content="View detailed information about this Minecraft Bedrock map. Download community-made MCPE maps." id="ogDescription">
    <meta property="og:image" content="https://pvcraft.net/home/imgs/og-map.png" id="ogImage">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://pvcraft.net/maps/index.html" id="twitterUrl">
    <meta property="twitter:title" content="PVCRAFT - Map Details" id="twitterTitle">
    <meta property="twitter:description" content="View detailed information about this Minecraft Bedrock map. Download community-made MCPE maps." id="twitterDescription">
    <meta property="twitter:image" content="https://pvcraft.net/home/imgs/og-map.png" id="twitterImage">
    ...
    <script type="module">
        ...
        async function loadMap() {
            ...
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    const aboutContent = data.about || "A Minecraft Pocket Edition map.";
                    ...
                    const ogImage = images.length > 0 ? images[0] : "https://pvcraft.net/home/imgs/og-map.png";
                    const currentUrl = window.location.href;
                        ...
                        <div class="carousel-slides">
                            ${images.map((img, index) => `
                                <div class="carousel-slide ${index === 0 ? 'active' : ''}">
                                    <img src="${img}" alt="Imagem ${index + 1} do mapa" class="carousel-image">
                                </div>
                            `).join('')}
                        </div>
                ...
                `;
                    ...
                    <div class="additional-info">
                        <div class="info-section">
                            <h3 class="info-title">About the map</h3>
                ...
                `;
                    ...
                    // Load related maps - NOVA IMPLEMENTAÇÃO CORRIGIDA
                    loadRelatedMaps(data, mapId);
                } else {
                    window.location.href = "/maps/index.html";
                }
            } catch (error) {
        ...
        function extractKeywords(content) {
            ...
            const commonWords = ['the', 'and', 'for', 'with', 'this', 'that', 'are', 'from', 'you', 'your', 'minecraft', 'map', 'maps', 'pe', 'mcpe', 'bedrock', 'adventure', 'parkour', 'survival', 'puzzle', 'mini', 'game', 'world', 'download'];
        ...
        async function loadRelatedMaps(currentContent, currentId) {
            try {
                // Buscar todos os maps (excluindo o atual)
                const allMapsQuery = query(
                    collection(db, "maps"),
                ...
                console.log('Palavras-chave extraídas do mapa atual:', allKeywords);
                ...
                console.log('Maps relacionados ordenados:', scoredContent.slice(0, 5));
                ...
                if (selectedContent.length > 0) {
                    selectedContent.forEach(item => {
                        ...
                        html += `
                        <div class="side-card">
                            <a href="/maps/index.php?id=${item.id}">
                    ...
                    console.log('Nenhum map relacionado encontrado, usando fallback aleatório');
                ...
                <div class="view-more">
                    <a href="/maps/index.html">
                        <i class="fas fa-ellipsis-h"></i> SEE MORE MAPS
                    </a>
                </div>
                `;
                ...
                console.error("Error loading related maps:", error);
                
                // Fallback: mostrar mensagem de erro
                document.querySelector('.side-cards').innerHTML = `
                    <div class="error-message">
                        <p>Unable to load related maps at this time.</p>
                        <div class="view-more">
                            <a href="/maps/index.html">
                                <i class="fas fa-ellipsis-h"></i> BROWSE ALL MAPS
                            </a>
                        </div>
                    </div>
                `;
